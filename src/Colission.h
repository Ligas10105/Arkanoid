...
public:
    ...
    static sf::Vector2f closestVertice(const Vertices &rectangle, const Circle &circle);

    static void circleProjection(const Circle &circle, const sf::Vector2f &axis, float &min, float &max);

    static sf::Vector2f circleAxis(const Circle &circle, const sf::Vector2f &closest_vertice);
